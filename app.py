...
@app.route("/")
def index():
    url = random.choice(images) # random selection everytime user hits home/refresh
    return render_template("index.html", url=url)


if __name__ == "__main__":
    app.run(host="0.0.0.0", port=int(os.environ.get("PORT", 5000))) #exposing port 5000
